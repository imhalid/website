...
const controls = useDragControls()
  return (
    <motion.div dragControls={controls} drag className="w-[660px] rounded-md overflow-hidden bg-neutral-950 shadow-inner-dark flex flex-col cursor-move">
      ...
      <motion.div drag={false} className="max-h-96 overflow-auto custom-scroll-bar">
